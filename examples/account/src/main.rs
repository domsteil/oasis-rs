...
impl Account {
    ...
    pub fn new(ctx: &Context, accountId: String, accountName: String, accountType: String, industry: String, rating: String, description: String) -> Result<Self> {
        Ok(Self {
            accountId,
            accountName,
            accountType,
